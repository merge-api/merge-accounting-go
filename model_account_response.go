...
func (v *AccountResponse) UnmarshalJSON(src []byte) error {
    type AccountResponseUnmarshalTarget AccountResponse

	var intermediateResult AccountResponseUnmarshalTarget
	...
	*v = AccountResponse(intermediateResult)
	return nil
}
