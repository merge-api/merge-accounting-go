...
// ExpenseLine # The ExpenseLine Object ### Description The `ExpenseLine` object is used to represent an expense's line items.  ### Usage Example Fetch from the `GET Expense` endpoint and view the expense's line items.
...
func (o *ExpenseLine) SetRemoteIdNil() {
	o.RemoteId.Set(nil)
}
...
func (o *ExpenseLine) SetNetAmountNil() {
	o.NetAmount.Set(nil)
}
...
func (o *ExpenseLine) SetTrackingCategoryNil() {
...
func (o *ExpenseLine) SetCompanyNil() {
	o.Company.Set(nil)
}
...
func (o *ExpenseLine) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *ExpenseLine) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *ExpenseLine) SetDescriptionNil() {
...
func (o *ExpenseLine) SetExchangeRateNil() {
...
func (o ExpenseLine) MarshalJSON() ([]byte, error) {
...
func (v *ExpenseLine) UnmarshalJSON(src []byte) error {
    type ExpenseLineUnmarshalTarget ExpenseLine

	var intermediateResult ExpenseLineUnmarshalTarget
	...
	*v = ExpenseLine(intermediateResult)
	return nil
}
type NullableExpenseLine struct {
	value *ExpenseLine
	isSet bool
}

func (v NullableExpenseLine) Get() *ExpenseLine {
	return v.value
}

func (v *NullableExpenseLine) Set(val *ExpenseLine) {
	v.value = val
	v.isSet = true
}

func (v NullableExpenseLine) IsSet() bool {
	return v.isSet
}

func (v *NullableExpenseLine) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpenseLine(val *ExpenseLine) *NullableExpenseLine {
	return &NullableExpenseLine{value: val, isSet: true}
}

func (v NullableExpenseLine) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpenseLine) UnmarshalJSON(src []byte) error {
	v.isSet = true
