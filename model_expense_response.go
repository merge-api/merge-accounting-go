...
// ExpenseResponse struct for ExpenseResponse
type ExpenseResponse struct {
	Model Expense `json:"model"`
...
func (o ExpenseResponse) MarshalJSON() ([]byte, error) {
...
func (v *ExpenseResponse) UnmarshalJSON(src []byte) error {
    type ExpenseResponseUnmarshalTarget ExpenseResponse

	var intermediateResult ExpenseResponseUnmarshalTarget
	...
	*v = ExpenseResponse(intermediateResult)
	return nil
}
type NullableExpenseResponse struct {
	value *ExpenseResponse
	isSet bool
}

func (v NullableExpenseResponse) Get() *ExpenseResponse {
	return v.value
}

func (v *NullableExpenseResponse) Set(val *ExpenseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExpenseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExpenseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpenseResponse(val *ExpenseResponse) *NullableExpenseResponse {
	return &NullableExpenseResponse{value: val, isSet: true}
}

func (v NullableExpenseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpenseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
