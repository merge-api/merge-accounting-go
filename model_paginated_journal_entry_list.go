...
func (v *PaginatedJournalEntryList) UnmarshalJSON(src []byte) error {
    type PaginatedJournalEntryListUnmarshalTarget PaginatedJournalEntryList

	var intermediateResult PaginatedJournalEntryListUnmarshalTarget
	...
	*v = PaginatedJournalEntryList(intermediateResult)
	return nil
}
