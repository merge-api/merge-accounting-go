...
**TotalAmount** | Pointer to **NullableFloat64** | The total amount of money being paid to the supplier, or customer, after taxes. | [optional] 
...
`func (o *Payment) GetTotalAmountOk() (*float64, bool)`
...
`func (o *Payment) SetTotalAmount(v float64)`
...
`func (o *Payment) GetModifiedAt() time.Time`

GetModifiedAt returns the ModifiedAt field if non-nil, zero value otherwise.

### GetModifiedAtOk

`func (o *Payment) GetModifiedAtOk() (*time.Time, bool)`
...
`func (o *Payment) SetModifiedAt(v time.Time)`

SetModifiedAt sets ModifiedAt field to given value.

### HasModifiedAt

`func (o *Payment) HasModifiedAt() bool`
